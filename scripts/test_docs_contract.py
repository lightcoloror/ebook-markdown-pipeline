...
def main() -> int:
    required = {
        ...
        "docs/TOOL_CONTRACT.md": [
            ...
            "adaptive-routing-plan-v1",
            "adaptive-pdf-probe-plan-v1",
            "prepare_adaptive_pdf_probe",
            "start_adaptive_pdf_probe",
            "auto_accept=true",
            "routing_profile",
            "preflight_probe_compare_escalate",
            "candidate-run-preview-v1",
            "candidate-readiness-contract-v1",
            "list_candidate_backends",
            "candidate-backend-list-v1",
            "scripts/list_candidate_backends.py",
            "readiness_contract",
            "needs_server",
            "review_pages",
            "table_review_matrix",
            "table-review-matrix-v1",
            "formula_review_matrix",
            "formula-review-matrix-v1",
            "check_formula_retention",
            "--review-bundle",
            "table_evidence_completeness",
            "needs_card_layout_false_positive_review",
            "formula_evidence_completeness",
            "needs_formula_retention_review",
            "layout-table-review-page-v1",
            "layout_table_review_bundle_json",
            "optional_backend_scorecard_json",
            "candidate_benchmark_plan_json",
            "web-archive-visual-check-v1",
            ...
            "chunk-map-v1",
            "build_chunk_map",
            "metadata_only_no_platform_import",
            "academic-evidence-v1",
            "build_academic_evidence",
            "side_evidence_only_no_default_route_change",
            "format-baseline-matrix-v1",
            "build_format_baseline_matrix",
            "inspect_only_side_evidence",
            "document-intelligence-blocks-v1",
            "build_document_intelligence_blocks",
            "not_performed_by_this_builder",
            "run_preview",
        ...
        "docs/ARCHITECTURE.md": [
            ...
            "adaptive_router.py",
            "adaptive_probe.py",
            "scripts/compare_pipelines.py --page-ranges",
        ...
        "benchmarks/README.md": [
            "build_candidate_benchmark_manifest.py",
            "candidate-benchmark-plan",
            "candidate_backend_previews",
            "candidate-run-preview-v1",
            "build_layout_table_review_bundle.py",
            "layout-table-review-bundle.json/md",
            "--scorecard",
            "--candidate-plan",
            "benchmark_context",
            "expected_artifact_coverage",
            "review_pages",
            "table_review_matrix",
            "--review-bundle",
            "table_evidence_completeness",
