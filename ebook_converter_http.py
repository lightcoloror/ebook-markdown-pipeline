                ...
                self.write_json(
                    {
                        ...
                        "candidate_backend_registry": operating_context.get("candidate_backend_registry", {}),
                        "candidate_artifact_schemas": operating_context.get("candidate_artifact_schemas", {}),
                        "diagnostic_artifact_schemas": operating_context.get("diagnostic_artifact_schemas", {}),
                        "backend_status": {
