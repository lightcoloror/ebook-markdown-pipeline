...
JSON_ARTIFACT_KEYS = (
    ...
    "document_quality_evaluation_json",
...
def infer_artifact_type(path: Path) -> str:
    ...
    if suffix == ".json":
        for marker, artifact_type in (
            ...
            ("pipeline-comparison", "pdf_pipeline_comparison_json"),
            ...
            ("docling-document", "docling_document_json"),
            ("docling_document", "docling_document_json"),
            ("document-quality-evaluation", "document_quality_evaluation_json"),
            ("document_quality_evaluation", "document_quality_evaluation_json"),
            ("document-provenance", "document_provenance_json"),
            ("document_provenance", "document_provenance_json"),
